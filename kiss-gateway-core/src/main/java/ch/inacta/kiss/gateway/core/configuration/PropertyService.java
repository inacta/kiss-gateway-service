package ch.inacta.kiss.gateway.core.configuration;

import ch.inacta.kiss.gateway.api.v1.model.ServiceRuntimeException;
...
import static ch.inacta.kiss.gateway.api.v1.model.ErrorResponseMessage.PROPERTY_NOT_FOUND_ERROR;
